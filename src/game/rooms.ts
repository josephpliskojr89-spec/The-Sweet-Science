...
export const ROOMS: Record<RoomKey, RoomDef> = {
  ...
  mail: {
    key: 'mail',
    name: 'The Mail',
    tagline: 'The tray. Questions the world is asking you.',
    contents: ['Letters and telegrams', 'Answers with consequences'],
    arrivesIn: 'live',
  },
  phone: {
    key: 'phone',
    name: 'The Phone',
    tagline: 'Fight booking. Message slips and the book.',
    contents: [
      'Return promoter calls — book or pass',
      'Bouts on the book, with corner plans',
    ],
    arrivesIn: 'live',
  },
  calendar: {
